...
- Mensagem exibida quando nenhuma foto é encontrada
...
- HTML5  
- CSS3  
- JavaScript (DOM, eventos e manipulação de arrays)
...
Este projeto foi desenvolvido exclusivamente para fins educacionais, seguindo os requisitos do trabalho proposto, com foco em organização de código, lógica em JavaScript e boas práticas básicas de front-end.
